...
export function API({ stack }: StackContext) {
  ...
  const WHATS_MESS_URL = new Config.Parameter(stack, "WHATS_MESS_URL", {
    value: "https://script.googleusercontent.com/macros/echo?user_content_key=p5cklRNXWqi8NKcBoI0oNyW0zsURynoPECjci_BvwG055TRnaj6zhWFv6CdsNH6aEZn20zgw2ChdNkk80LkEQQCnvUe1ZxWyOJmA1Yb3SEsKFZqtv3DaNYcMrmhZHmUMWojr9NvTBuBLhyHCd5hHa8J4NQyrVEFMtB0_KJVYuOT_3bQKrHo7NkqtUPg2gdSiiSDTapmBxaiEQCVX2MjV4g-KpqedECJYHF0hyHl7ss-YBYggDTTSTEJjikwa16IO-sxGS-3BWS1id3ZL8DJkJg&lib=ME6R_9-iwVkE5ZAWFx9_jKCyrCrPpogKk"
  })
  ...
  api.bind([MONGODB_URI, REDIS_PASSWORD, REDIS_HOST, REDIS_PORT, GUPSHUP_KEY, GUPSHUP_FROM_NUMBER, MY_PHONE, BOT_PHONE, MY_MAILID, RETURN_NUMBER, NOTIFY_URL, GUPSHUP_APP_NAME, SEND_URL, BLOCK_URL, WHATS_MESS_URL, SRM_DO_URL, SRM_TOKEN_URL, SRM_USER_URL])
  ...
  cron.bind([MONGODB_URI, REDIS_PASSWORD, REDIS_HOST, REDIS_PORT, GUPSHUP_KEY, GUPSHUP_FROM_NUMBER, MY_PHONE, BOT_PHONE, MY_MAILID, RETURN_NUMBER, NOTIFY_URL, GUPSHUP_APP_NAME, SEND_URL, BLOCK_URL, WHATS_MESS_URL, SRM_DO_URL, SRM_TOKEN_URL, SRM_USER_URL])
